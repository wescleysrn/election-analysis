...
public class CandidateRest {
	...
	public HttpEntity<Map<String, Object>> personDonationGraph(
			@RequestParam(value = "limit",required = false) Integer limit) throws BusinessException {
		try {
	...
	public HttpEntity<Map<String, Object>> companyDonationGraph(
			@RequestParam(value = "limit",required = false) Integer limit) throws BusinessException {
		try {
